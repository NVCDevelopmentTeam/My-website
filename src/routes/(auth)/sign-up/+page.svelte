...
<div class="min-h-screen flex items-center justify-center bg-background py-12 px-4 sm:px-6 lg:px-8">
	<div class="max-w-md w-full space-y-8">
		<div>
			...
			<p class="mt-2 text-center text-sm text-muted-foreground">Join us today and get started</p>
		</div>
				...
				<div class="space-y-4">
					...
					<div>
						...
						<input
							...
							class="appearance-none relative block w-full px-3 py-2 border {$errors.email
								? 'border-destructive'
								: 'border-border'} placeholder-muted-foreground text-foreground rounded-md focus:outline-none focus:ring-primary focus:border-primary focus:z-10 sm:text-sm"
					...
					<div>
						...
						<input
							...
							class="appearance-none relative block w-full px-3 py-2 border {$errors.firstName
								? 'border-destructive'
								: 'border-border'} placeholder-muted-foreground text-foreground rounded-md focus:outline-none focus:ring-primary focus:border-primary focus:z-10 sm:text-sm"
					...
					<div>
						...
						<input
							...
							class="appearance-none relative block w-full px-3 py-2 border {$errors.lastName
								? 'border-destructive'
								: 'border-border'} placeholder-muted-foreground text-foreground rounded-md focus:outline-none focus:ring-primary focus:border-primary focus:z-10 sm:text-sm"
					...
					<div>
						...
						<input
							...
							class="appearance-none relative block w-full px-3 py-2 border {$errors.password
								? 'border-destructive'
								: 'border-border'} placeholder-muted-foreground text-foreground rounded-md focus:outline-none focus:ring-primary focus:border-primary focus:z-10 sm:text-sm"
