...
<div class="relative w-full max-w-md">
		...
		<div class="relative flex items-center">
			...
			{#if voiceSearchSupported}
				<button
					...
					class={'absolute right-10 top-1/2 transform -translate-y-1/2 p-1 rounded-full hover:bg-muted focus:outline-none focus:ring-2 focus:ring-ring transition-colors duration-200 ' +
	...
	{#if isListening}
		<div
			class="absolute top-full left-0 right-0 mt-2 bg-red-50 border border-red-200 rounded-lg p-3 z-50 shadow-lg"
		>
